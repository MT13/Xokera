...
var SceneManager = new Class({
    ...
    bootScene: function (scene)
    {
        ...
        if (loader && scene.preload)
        {
            ...
            {
                console.log("in bootScene in loader before create");
            ...
            else
            {
                ...
                console.log("in bootScene loader start");
        ...
        else
        {
            ...
            console.log("in bootScene in else create");
    ...
    create: function (scene)
    {
        ...
        if (scene.create)
        {
            ...
            console.log("in create create exists");
    ...
    start: function (key, data)
    {
        ...
        if (scene)
        {
            ...
            console.log("before booting " + key);
